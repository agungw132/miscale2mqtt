...
MISCALE_MAC = sys.argv[1]
MQTT_USERNAME = sys.argv[4]
MQTT_PASSWORD = sys.argv[5]
MQTT_HOST = sys.argv[2]
MQTT_PORT = int(sys.argv[3])
MQTT_TOPIC = sys.argv[8]
MQTT_TOPIC2 = sys.argv[7]
MQTT_TIMEOUT = int(sys.argv[6])
...
class ScanProcessor():
    ...
    def _publish(self, weight, unit):
        ...
        prefix = '{}/{}'.format(MQTT_TOPIC, unit)
        message = json.dumps({ "weight" : weight})
        self.mqtt_client.publish(prefix, message, qos=0, retain=False)
